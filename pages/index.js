...
export default function App() {
  ...
  const regionsDetail = ["US East 美国东部 (N. Virginia 弗吉尼亚)", "US East 美国东部 (Ohio 俄亥俄)", "US West 美国西部 (N. California 加利福尼亚)", "US West 美国西部 (Oregon 俄勒冈)", "Africa 非洲 (Cape Town 开普敦)", "Asia Pacific 亚太地区 (Hong Kong 香港)", "Asia Pacific 亚太地区 (Hyderabad 海得拉巴)", "Asia Pacific 亚太地区 (Jakarta 雅加达)", "Asia Pacific 亚太地区 (Mumbai 孟买)", "Asia Pacific 亚太地区 (Osaka 大阪)", "Asia Pacific 亚太地区 (Seoul 首尔)", "Asia Pacific 亚太地区 (Singapore 新加坡)", "Asia Pacific 亚太地区 (Sydney 悉尼)", "Asia Pacific 亚太地区 (Tokyo 东京)", "Canada 加拿大 (Central 中部)", "Europe 欧洲 (Frankfurt 法兰克福)", "Europe 欧洲 (Ireland 爱尔兰)", "Europe 欧洲 (London 伦敦)", "Europe 欧洲 (Milan 米兰)", "Europe 欧洲 (Paris 巴黎)", "Europe 欧洲 (Spain 西班牙)", "Europe 欧洲 (Stockholm 斯德哥尔摩)", "Middle East 中东 (Zurich 苏黎世)", "Middle East 中东 (Bahrain 巴林)", "Middle East 中东 (UAE 阿联酋)", "South America 南美洲 (São Paulo 圣保罗)"];
  const systems = ["debian-11", "debian-12", "Amazon-Linux-2", "ubuntu-22.04", "ubuntu-24.04", "arch-linux", "windows-server-2022-sc", "windows-server-2022-en"];
  const systemsDetail = ["Debian 11", "Debian 12", "Amazon Linux2", "Ubuntu 22.04", "Ubuntu 24.04", "Arch Linux", "Windows Server 2022 简体中文版", "Windows Server 2022 英文版"];
  const systemImageNameMap = new Map([["debian-11", "debian-11-amd64-2024*"], ["debian-12", "debian-12-amd64-*"], ["Amazon-Linux-2","amzn2-ami-kernel-5.10-hvm-2.0.2024*"], ["ubuntu-22.04", "ubuntu/images/hvm-ssd/ubuntu-jammy-22.04-amd64-server-2024*"], ["ubuntu-24.04", "ubuntu/images/hvm-ssd-gp3/ubuntu-noble-24.04-amd64-server-2024*"], ["Arch Linux", "*"], ["windows-server-2022-sc", "Windows_Server-2022-Chinese_Simplified-Full-Base-*"], ["windows-server-2022-en", "Windows_Server-2022-English-Full-Base-*"]]);
  const systemImageOwnerMap = new Map([["debian-11", "136693071363"], ["debian-12", "136693071363"], ["Amazon-Linux-2","137112412989"], ["ubuntu-22.04", "099720109477"], ["ubuntu-24.04", "099720109477"], ["Arch Linux", "647457786197"], ["windows-server-2022-sc", "801119661308"], ["windows-server-2022-en", "801119661308"]]);
        ...
        {isShowAdvancedOptions ? (
          ...
          <FormControl sx={{ m: 1, minWidth: 150 }} size="small">
            ...
            <Select labelId="select-system-label" label="操作系统" value={system} onChange={e => {
              ...
              if (e.target.value == "debian-11" || e.target.value == "debian-12" || e.target.value == "Amazon-Linux-2" || e.target.value == "ubuntu-22.04" || e.target.value == "ubuntu-24.04" || e.target.value == "arch-linux") {
                setSystemType("Linux");
              }
